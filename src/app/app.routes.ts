...
import { ClinicStatsComponent } from './admin/clinic-stats/clinic-stats.component';
import { UsersComponent } from './admin/users/users.component';
import { SearchRecordsComponent } from './admin/search-record/search-record.component';
...
export const routes: Routes = [
  ...
  { path: 'admin/stats', component: ClinicStatsComponent },
  { path: 'admin/users',component: UsersComponent },
{ path: 'admin/search-records', component: SearchRecordsComponent },
